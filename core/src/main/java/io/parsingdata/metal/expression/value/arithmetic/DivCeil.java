...
public class DivCeil extends BinaryValueExpression {

    public DivCeil(final ValueExpression left, final ValueExpression right) {
        super(left, right);
    }
    ...
    public OptionalValue eval(final Value left, final Value right, final Environment environment, final Encoding encoding) {
        ...
        return OptionalValue.of(ConstantFactory.createFromNumeric(leftDecimal.divide(rightDecimal, BigDecimal.ROUND_CEILING).toBigInteger(), encoding));
    }
}
