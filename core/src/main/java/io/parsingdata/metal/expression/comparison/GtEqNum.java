...
/**
 * A {@link ComparisonExpression} that implements the greater than or equals
 * operator for integers.
 * <p>
 * Both values are interpreted as integers. The {@link #compare(Value, Value)}
 * method returns <code>true</code> if the left value is greater than or
...
public class GtEqNum extends ComparisonExpression {
    ...
    public GtEqNum(final ValueExpression value, final ValueExpression predicate) {
