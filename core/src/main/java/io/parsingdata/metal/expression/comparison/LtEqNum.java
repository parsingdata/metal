...
/**
 * A {@link ComparisonExpression} that implements the less than or equals
 * operator for integers.
 * <p>
 * Both values are interpreted as integers. The {@link #compare(Value, Value)}
 * method returns <code>true</code> if the left value is less than or equals
 * the right value.
 *
 * @see EqNum
 * @see LtNum
...
public class LtEqNum extends ComparisonExpression {
    ...
    public LtEqNum(final ValueExpression value, final ValueExpression predicate) {
