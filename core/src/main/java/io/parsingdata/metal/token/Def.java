...
public class Def extends Token {
    ...
    protected ParseResult parseImpl(final String scope, final Environment env, final Encoding enc) throws IOException {
        ...
        final Environment newEnv = new Environment(env.order.add(new ParseValue(scope, _name, this, env.offset, data, enc, env.order.getSequenceId() + 1)), env.input, env.offset + size.get().asNumeric().intValue());
