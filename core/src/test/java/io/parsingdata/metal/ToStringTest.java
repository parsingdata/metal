...
public class ToStringTest {
    ...
    public void data() {
        ...
        final ParseValue pv1 = new ParseValue("name", NONE, Source.create(0L, 2), new byte[]{1, 2}, enc());
        ...
        final ParseValue pv2 = new ParseValue("two", NONE, Source.create(0L, 2), new byte[]{3, 4}, enc());
