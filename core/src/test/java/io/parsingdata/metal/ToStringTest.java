...
public class ToStringTest {
    ...
    public void data() {
        ...
        final ParseValue pv1 = new ParseValue("name", NONE, new ByteArraySource(new byte[]{1, 2}), enc());
        final String pv1String = "name(0x0102)";
        final OptionalValue ov1 = OptionalValue.of(pv1);
        final OptionalValue ov2 = OptionalValue.of(new Value(new ByteArraySource(new byte[]{3}), enc()));
        assertEquals(">OptionalValue(0x03)>OptionalValue(" + pv1String + ")", ImmutableList.create(ov1).add(ov2).toString());
        final ParseValue pv2 = new ParseValue("two", NONE, new ByteArraySource(new byte[]{3, 4}), enc());
