...
public class NthExpressionTest {
    ...
    public void testNanIndex() throws IOException {
        ...
        final ImmutableList<OptionalValue> values = nth(ref("value"), div(con(0), con(0))).eval(result.environment, enc());
    ...
    public void testEmptyValuesSingleIndex() throws IOException {
        ...
        final ImmutableList<OptionalValue> values = makeList(stream(0, 1, 0), 1);
        assertThat(values.head.isPresent(), is(equalTo(false)));
    }
    ...
    public void testNonExistingValueAtIndex() throws IOException {
        ...
        final ImmutableList<OptionalValue> values = makeList(stream(5, 1, 2, 3, 4, 5, 1, 42), 1);
        assertThat(values.head.isPresent(), is(equalTo(false)));
    }
    ...
    public void testNegativeIndex() throws IOException {
        ...
        final ImmutableList<OptionalValue> values = makeList(stream(5, 1, 2, 3, 4, 5, 1, -1), 1);
        assertThat(values.head.isPresent(), is(equalTo(false)));
    }
    ...
    public void testSingleIndex() throws IOException {
        ...
        final ImmutableList<OptionalValue> values = makeList(stream(5, 1, 2, 3, 4, 5, 1, 0), 1);
    ...
    public void testMultipleIndices() throws IOException {
        ...
        final ImmutableList<OptionalValue> values = makeList(stream(5, 1, 2, 3, 4, 5, 2, 0, 2), 2);
    ...
    public void testMultipleIndicesMixedOrder() throws IOException {
        ...
        final ImmutableList<OptionalValue> values = makeList(stream(5, 5, 6, 7, 8, 9, 4, 3, 2, 0, 4), 4);
    ...
    public void testMixedExistingNonExistingIndices() throws IOException {
        ...
        final ImmutableList<OptionalValue> values = makeList(stream(5, 1, 2, 3, 4, 5, 3, 0, 42, 2), 3);
        assertThat(values.head.get().asNumeric().intValue(), is(equalTo(3)));
    ...
    public void testResultLengthEqualsIndicesLength() throws IOException {
        ...
        final ImmutableList<OptionalValue> values = makeList(stream(1, 1, 5, 1, 2, 3, 4, 5), 5);
        assertNonePresent(values);
    }

    private void assertNonePresent(final ImmutableList<OptionalValue> inputValues) {
        ImmutableList<OptionalValue> values = inputValues;
    ...
    private ImmutableList<OptionalValue> makeList(final Environment environment, final long listSize) throws IOException {
        final ParseResult result = format.parse(environment, signed());
        assertTrue(result.succeeded);
        final ImmutableList<OptionalValue> values = nth.eval(result.environment, signed());
