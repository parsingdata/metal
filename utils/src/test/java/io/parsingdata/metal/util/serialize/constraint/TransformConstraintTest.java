...
public class TransformConstraintTest {
    ...
    private static final Token INNER = str("INNER", def("value", con(1)));
    ...
    private static final Token OUTER3 = str("OUTER", def("value", con(1)));
    ...
    private static final Token DOUBLE_SUB_INNER2 = str("INNER2", def("value", con(1)));
    ...
    private static final Token THREE_VALUES = seq(def("value1", con(1)), def("value2", con(1)), def("value3", con(1)));
