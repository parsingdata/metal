...
public class TransformSerializerTest {
    ...
    @Test
    public void testNothingTransformed() throws IOException {
        final byte[] input = {0, 1};
    ...
    @Test
    public void testNullConstraint() throws IOException {
        final byte[] input = {0, 1};
    ...
    @Test
    public void testNullTransformator() throws IOException {
        final byte[] input = {0, 1};
