...
/**
 * A composition of a constraint, a name and a transformer, representing the
 * when, what and how used for transforming values in a graph.
 *
 * See {@link TransformConstraint} and {@link ParseValueTransformer}.
 *
 ...
 * A value matching this fieldName will be transformed using the supplied transformer.
 *
