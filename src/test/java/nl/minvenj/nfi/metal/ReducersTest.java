...
public class ReducersTest extends ParameterizedParse {
    ...
    private final static Token reduceAddAInit0 = token(1, eq(reduce("a", addReducer, con(0))));
    private final static Token reduceAddAInit1 = token(1, eq(reduce("a", addReducer, con(1))));
